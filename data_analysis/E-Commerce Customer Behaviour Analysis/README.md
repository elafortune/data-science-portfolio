...
🚀 1. Analyse RFM : Comprendre la valeur client et préparer la segmentation.
...
🛒 2. Analyse du panier & valeur client: Comprendre comment les clients achètent et identifier les profils à forte valeur.
...
🛠️ Technologies utilisées : Python
 librairies : Pandas, plotly, mlxtend
 pandas==2.2.3
 plotlty==6.3.0
 mlxtend==0.23.4
